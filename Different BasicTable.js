...
const BasicTable = ()=> {
    ...
    return (
        <>
        <div style={{ marginLeft:"1010px"}}>
            <input type="text" placeholder="Search by TradeID" onChange={handleChange}/>
        </div>
            <div className={classes.root} style={{height: 400, width: '91.5%', backgroundColor: 'white', position: 'absolute',marginLeft:'50px', top: '120px', boxShadow: '0px 3px 3px -2px rgb(0 0 0 / 20%), 0px 3px 4px 0px rgb(0 0 0 / 14%), 0px 1px 8px 0px rgb(0 0 0 / 12%)', transition: 'box-shadow 300ms cubic-bezier(0.4, 0, 0.2, 1) 0ms;' }}>
                <DataGrid
                    columns={columns}
                    rows={data}
                    components={{
